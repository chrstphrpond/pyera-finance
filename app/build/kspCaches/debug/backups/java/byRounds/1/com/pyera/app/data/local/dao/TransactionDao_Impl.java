  ...
  public TransactionDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTransactionEntity = new EntityInsertionAdapter<TransactionEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `transactions` (`id`,`amount`,`note`,`date`,`type`,`categoryId`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfTransactionEntity = new EntityDeletionOrUpdateAdapter<TransactionEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `transactions` SET `id` = ?,`amount` = ?,`note` = ?,`date` = ?,`type` = ?,`categoryId` = ? WHERE `id` = ?";
      }
      ...
      public List<TransactionEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new TransactionEntity(_tmpId,_tmpAmount,_tmpNote,_tmpDate,_tmpType,_tmpCategoryId);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public TransactionEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new TransactionEntity(_tmpId,_tmpAmount,_tmpNote,_tmpDate,_tmpType,_tmpCategoryId);
          } else {
            _result = null;
          }
          return _result;
